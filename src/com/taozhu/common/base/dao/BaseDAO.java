package com.taozhu.common.base.dao;
...
import com.taozhu.common.mybatis.page.util.PageUtil;
...
import com.taozhu.common.mybatis.vo.RecordValue;
...
public class BaseDAO<T> extends SqlSessionDaoSupport {
	...
	public final String BASE_NAMESPACE = "com.taozhu.Base";
	
	public static String BASE_PREFIX = "com.taozhu.persistence.";
	...
	public int getBusiDataSeq(String code,int date){
		Map map = new HashMap();
		map.put("CODE", code);
		map.put("DATE", date);
		this.getSqlSession().selectList(BASE_NAMESPACE + ".getBusiDateSeq", map);
		int seq = BaseDAOUtil.getIntValue(map, "SEQ");
		return seq;
	}
	/**
	 * insert方法
