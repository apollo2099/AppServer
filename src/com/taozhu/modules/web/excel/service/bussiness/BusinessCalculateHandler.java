...
@Service("BusinessCalculateHandler")
public class BusinessCalculateHandler implements ICalculateHandler{
	@Resource
	...
	public FileDefine execute(FileDefine df, Map<String, String> param) {
		...
		Map map = (Map)baseDAO.select("BusinessMapper.calculate",pm);
