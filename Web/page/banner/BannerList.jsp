...
<t:datagrid name="InterfaceGrid" sqlMap="com.taozhu.persistence.BannerMapper.queryBannerList" queryMode="group"  checkbox="true">
	...
	<t:dgToolBar title="新增" icon="icon-add" url="enterBanner.do?showDetail" width="600" height="400" funname="add"/>
	<t:dgToolBar title="修改" icon="icon-edit" url="enterBanner.do?showDetail" funname="update"/>
	<t:dgToolBar title="删除" icon="icon-remove" url="enterBanner.do?deleteBanner" funname="deleteALLSelect" />
</t:datagrid>
