...
<t:datagrid name="userGrid" sqlMap="com.taozhu.persistence.UserMapper.queryUserGrid" queryMode="group" checkbox="true">
	<t:queryCol title="帐号" field="account"/>
	<t:queryCol title="昵称" field="nickName"/>
	<t:queryCol title="性别" field="sex"/>
	...
	<t:dgToolBar title="修改密码" icon="icon-remove" url="userWebController.do?showUserPwd" funname="update"  height="300"/>
